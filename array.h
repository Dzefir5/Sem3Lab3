...
template <typename T> class DynamicArray
{
    ...
    public:
        ...
        DynamicArray(const DynamicArray<T> &input_array);
        DynamicArray(DynamicArray<T> &&input_array);
...
template <typename T> DynamicArray<T>::DynamicArray(const DynamicArray<T> &input_array)
{
    *this = input_array;
}

template <typename T> DynamicArray<T>::DynamicArray(DynamicArray<T> &&input_array)
{
    *this = std::move(input_array);
}
